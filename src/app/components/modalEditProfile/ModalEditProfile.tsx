...
export default function ModalEditProfile({
  ...
  const handleChangeName = (event: React.ChangeEvent<HTMLInputElement>) => {
    setUserPost({
      ...
      name: `${event.target.value} ${userPost.family_name}`,
    });
  };
  ...
  const handleChangeFamilyName = (
    ...
    setUserPost({
      ...
      name: `${userPost.given_name} ${event.target.value}`,
    });
  };
      ...
      >
        <Fade in={open}>
          <Box className="modalEditProfile__box">
            <h3 className="modalEditProfile__h3">Modificar datos</h3>
            ...
            <div className="modalEditProfile__div">
              <h5 className="modalEditProfile__h5">
            ...
            <div className="modalEditProfile__div">
              <h5 className="modalEditProfile__h5 modalEditProfile__h5--popover">
                Teléfono
                <button
                  onClick={handleClickPhoneNumberPopover}
                  className="modalEditProfile__popover__button"
                >
                ...
                >
                  <div className="modalEditProfile__popover__div">
                    ...
                    <ul>
                      ...
                      <li>
                        Nota: No es obligatorio colocar una nueva contraseña.
                      </li>
                    </ul>
                  </div>
                </Popover>
