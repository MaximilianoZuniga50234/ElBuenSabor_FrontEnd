...
const ModalEditProfile = lazy(
  () => import("../../components/modalEditProfile/ModalEditProfile")
);
      ...
      <Suspense fallback={<Loader />}>
        <main className="profile__main__container">
          <section className="profile__container">
              ...
              <div className="profile__form__div">
                <div className="profile__form__div__address">
                  ...
                  <input
                    ...
                    readOnly
                    defaultValue={
                      user?.user_metadata.address && isAddressValid
                        ? `${user?.user_metadata?.address?.street} ${user?.user_metadata?.address?.number}, ${user?.user_metadata?.address?.department}`
                        : ""
                    }
                  />
                </div>
                ...
                <div className="profile__form__div__phoneNumber">
                  ...
                  <input
                    ...
                    readOnly
                    defaultValue={
                      user?.user_metadata?.phone_number != 0
            ...
            <button className="profile__form__button" onClick={handleOpen}>
              Editar
            </button>
          </section>
